...
def Menu_option_3(Machines,Users):

    # #Docstring:
    #     """
    #     Infinate loop for menu option 3- enter machine data
    #     Allows adding, deleting and editing virtual machine info
    #     Also allows adding users populations from Users data structure from menu option 2
