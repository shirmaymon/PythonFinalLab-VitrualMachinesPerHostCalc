#Module for option 1 in menu - creates HOSTS data structure 

def Menu_Option1(Hosts):

    # #Docstring:
    #     """
    #     Infinate loop for menu option 1- enter hosts data
    #     Allows adding, deleting and editing hosts info
